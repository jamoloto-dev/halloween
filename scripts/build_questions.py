...
QUESTIONS = [
    ...
    },
    {
        ...
        "options": [
            ...
            "Hang garlic wreaths",
            "Spread sea salt on the stairs",
            "Bury an iron horseshoe",
        ],
    ...
    },
    {
        ...
        "options": [
            "Undead grave dwellers with superhuman strength",
            "Forest trolls that turn to stone",
            "Sea sirens who drown sailors",
            "Elves that bring winter storms",
        ],
    ...
    },
    {
        ...
        "options": [
            "To disguise themselves so wandering spirits would not harm them",
            "To scare rival tribes",
            "To honor wild animals",
            "To sneak past village guards",
        ],
    ...
    },
    {
        ...
        "options": [
            "Re-lighting household hearths from a single sacred communal fire",
            "Burning scarecrows to frighten wolves",
            "Sending smoke signals to neighboring hillforts",
            "Melting iron cauldrons for war",
        ],
    ...
    },
    {
        ...
        "options": [
            "Trapped carbon dioxide gas escaping at 600 psi",
            "Citric acid reacting with baking soda",
            "Sodium bicarbonate exploding in moisture",
            "Nitrogen gas sublimation",
        ],
    ...
    },
    {
        ...
        "options": [
            "They originally contained three flavors: chocolate, vanilla, and strawberry",
            "They were marketed to three-person families",
            "They were sliced into three equal pieces",
            "Three candy makers jointly developed them",
        ],
    ...
    },
    {
        ...
        "options": [
            "Confectioner's glaze (Shellac from lac bugs)",
            "Beeswax",
            "Gum Arabic",
            "Carnauba wax",
        ],
    ...
    },
    {
        ...
        "options": [
            "Halloween Peanut Butter Kisses (Mary Janes/Chews)",
            "Butterfinger Minis",
            "Chick-O-Sticks",
    ...
    },
    {
        ...
        "options": [
            "A physical object that mysteriously appears or disappears during a seance",
            "A ghost of a deceased pet",
            "A telepathic vision during sleep",
            "A cold draft felt in a warm room",
        ],
    ...
    },
    {
        ...
        "options": [
            ...
            "Harry Price and Arthur Conan Doyle",
            "Peter Venkman and Egon Spengler",
            "Hans Holzer and Sybil Leek",
        ],
    ...
    },
    {
        ...
        "options": [
            "Ganzfeld experiment",
            "Milgram experiment",
            "Stanford sensory test",
            "Monroe hemisphere sync",
        ],
    ...
    },
    {
        ...
        "options": [
            "The Flatwoods Monster (Green Monster)",
...
def main():
    ...
    print(
        f"Successfully generated and wrote {len(validated)} questions across {len(by_cat)} categories to {out_path}!"
    )
